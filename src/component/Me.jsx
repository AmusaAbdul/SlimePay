import MeHeader from "./homeComponent/meComponent/MeHeader";
import Asset from "./homeComponent/meComponent/Asset";
import QuickAccess from "./homeComponent/meComponent/QuickAccess";
import Others from "./homeComponent/meComponent/Others";
        ...
        <div className="homePage">
            ...
            <div className='homeNav'>
                <nav className="homeNavigation">
                    ...
                    <Link className='links' to="/home/wealth"> <button>
                        <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link className='links' to="/home/me"> <button>
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
